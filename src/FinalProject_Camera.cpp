...
int main(int argc, const char *argv[])
{
    ...
    */
        ...
        std::vector<double> ttcsLidar;
        std::vector<double> ttcsCam;
    ...
    double meanLidar;
    double meanCam;
    for(auto &a : ttcsLidar) meanLidar += a;
    for(auto &b : ttcsCam) meanCam += b;

    meanLidar /= ttcsLidar.size();
    meanCam   /= ttcsCam.size();

    std::cout<<"meanLidar: " <<meanLidar<<std::endl;
    std::cout<<"meanCam: " <<meanCam<<std::endl;
